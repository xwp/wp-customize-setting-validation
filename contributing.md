# Customize Setting Validation Contributing Guide
...
``` bash
$ git clone --recursive git@github.com:xwp/wp-customize-setting-validation.git customize-setting-validation
```
